...
using static finalProjectMobileApp.TaskClass;

namespace finalProjectMobileApp;

public partial class UnassignedTasksPage : ContentPage
{
	private TechnicianClass tech;
	public UnassignedTasksPage(TechnicianClass technician)
	{
		InitializeComponent();
